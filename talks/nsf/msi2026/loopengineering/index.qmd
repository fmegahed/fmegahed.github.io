...
<div class="etech"><ul><li>ERP</li><li>MES</li><li>IIoT sensing plant-wide</li></ul></div>
<div class="elimit">coordinated and data-rich, but not self-optimizing</div>
</div>
...
<div class="elimit">models analyze, predict, recommend; humans still run the improvement cycle</div>
</div>
...
<div class="etech"><ul><li>agents that experiment on the production system itself</li></ul></div>
...
Each wave automated the **running** of production. The wave arriving now automates its **improvement**, and improvement is an **experimentation problem**.
:::
