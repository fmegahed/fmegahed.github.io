...
.pull-left-2[<br>Megahed, F. M., Chen, Y. J., Zwetsloot, I., Knoth, S., Montgomery, D.C., & Jones-Farmer, L. A. (2024). Introducing ChatSQC: Enhancing Statistical Quality Control with Augmented AI. To appear in the *Journal of Quality Technology*.
...
.pull-left-2[<br>Megahed, F. M., Chen, Y. J., Ferris, J.A., Resatar, C., Ross, K., Lee, Y., & Jones-Farmer, L. A. (2024). ChatISA: A Prompt-Engineered Chatbot for Coding, Project Management, Interview and Exam Preparation Activities. Under review at *IEEE Transactions at Learning Technologies*.

Paper will be announced @ arXiv soon.]
...
# Conjentures based on Roger Hoerl's Work
...
2. **Considerations:**
   - Unequal costs associated with different model runs.
