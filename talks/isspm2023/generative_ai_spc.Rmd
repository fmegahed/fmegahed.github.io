...
```
```{r ai_apps_out, out.width='100%', dpi = 600}
...
```{r generative_ai_chart_out, out.width='100%', dpi = 600}
...
```{r generative_ai_dev_out, out.width='100%', dpi = 600}
...
```{r gen_ai_hype, out.width='100%', fig.height = 3.5, dpi = 600, echo=FALSE}
...
```{r gen_ai_hype2, out.width='100%', fig.height = 3.5, dpi = 600, echo=FALSE}
knitr::include_graphics('figs/fortune_mistral.png')
```
.center[.white[vertical scpacing]]
...
```
<center>
<img src="./figs/methods.png" alt="An overview of our study design" width="70%" height="70%" border="0" style="padding:0px; display: block; line-height: 0px; font-size: 0px; border:0px;" />
</center>
...
```{r spc_research_knowledge, echo=FALSE, out.width='70%'}
...
```{r code_exp_2, echo=FALSE, out.width='80%', fig.align='center'}
...
.pull-right[
```{r code_exp_3, echo=FALSE, out.width='90%', fig.align='center'}
...
```{r imprecise, out.width='60%', echo=FALSE}
knitr::include_graphics('figs/research_prompt_08_fig_01.png')
```
...
```{r bigfish1, out.width='60%', echo=FALSE}
...
```{r bigfish2, out.width='80%', echo=FALSE}
...
```{r conclusions, out.width='80%', dpi = 600, echo=FALSE}
...
```{r open_questions, out.width='50%', dpi = 600, echo=FALSE}
