...
Bianca Maria Colosimo, Marco L.G. Grasso &nbsp; [`r icons::icon_style(icons::fontawesome("link", style = "solid"), fill = "white")` Politecnico di Milano](https://www.mecc.polimi.it/en/staff/)<br>
...
Hongyue Sun &nbsp; [`r icons::icon_style(icons::fontawesome("link", style = "solid"), fill = "white")` University of Georgia](https://engineering.uga.edu/team_member/hongyue-sun/)<br>
...
date: 'July 24, 2025 | ISQC 2025 | Lisbon, Portugal'
output:
...
## The Central Role of Images in SQC

<html>
<center>
<video width="853" height="484">
<source src="figs/image_qc_full.mp4" type="video/mp4">
</center>
</video>
...
**Demo Data:** You can download the demo Duke Energy Data [here](https://github.com/fmegahed/fmegahed.github.io/raw/refs/heads/master/talks/enbis2025/data/duke_energy_weather_2020_2025.csv).
