...
author: '<br>Fadel M. Megahed, PhD <br><br> Associate Professor <br> Department of Information Systems and Analytics <br> Farmer School of Business<br> Miami University<br><br> <a href="https://github.com/fmegahed"><i class="fa fa-twitter fa-fw"></i>&nbsp; FadelMegahed</a><br> <a href="https://github.com/fmegahed"><i class="fa fa-github fa-fw"></i>&nbsp; fmegahed</a><br> <a href="mailto:fmegahed@miamioh.edu"><i class="fa fa-paper-plane fa-fw"></i>&nbsp; fmegahed@miamioh.edu</a><br> <a href="https://calendly.com/fmegahed"><i class="fa fa-question"></i>&nbsp; Automated Scheduler for Virtual Office Hours</a><br><br>'
date: "Spring 2022"
output:
...
cal = calendR(title = 'A Temporal Visualization of Crashes in Cincy in 2021',
              year = 2021,
...
### A Spatiotemporal Visualization of Crashes in Cincy
...
tmap_animation(tm_base, filename = 'figures/crash_anim.gif', fps = 3,
               width = 1000, height = 350, outer.margins = 0)
```
...
# Why Should you Care? Evidence from Indeed [1]
...
# Why Should you Care? Evidence from Indeed [2]
...
# Why Should you Care? Read this Job Ad
...
# Why Should you Care? Recent Alumni Testimonials
...
# An Overview of My Research Portfolio [1]
...
CS = conceptualStructure(M,
                         ...
                         clust=4, labelsize=15, documents=45)
```

```{r research_megahed2, echo=FALSE, out.width='100%', fig.alt="My work can be grouped into four different clusters", fig.align='center', fig.cap='My work can be grouped into four different clusters.'}
CS$graph_dendogram
```

---

# An Overview of My Research Portfolio [2]

```{r research_megahed3, echo=FALSE, out.width='100%', fig.alt="My work can be grouped into four different clusters", fig.align='center', fig.cap='My work can be grouped into four different clusters.'}
CS$graph_terms
```
...
# An Overview of My Research Portfolio [3]

```{r app_megahed, echo=FALSE}
knitr::include_url('http://dataviz.miamioh.edu/Heart-Transplant/monotonic/')
```
...
.pull-right[
```{r bnj_nowak, echo=FALSE}
knitr::include_graphics('https://pbs.twimg.com/media/FIxQ_MNXEAAJhqk?format=jpg&name=small')
```
]
